...
# Fallback-Zuordnung anhand von Schluesselwoertern im Control-Namen (DE/EN),
...
NAME_DEVICE_CLASS_MAP: tuple[tuple[tuple[str, ...], BinarySensorDeviceClass], ...] = (
    ...
    (("door", "tür", "tuer", "türe", "tuere"), BinarySensorDeviceClass.DOOR),
    (("smoke", "rauch"), BinarySensorDeviceClass.SMOKE),
    (("sound", "geräusch", "geraeusch", "noise", "lärm", "laerm"), BinarySensorDeviceClass.SOUND),
    (("moisture", "feucht", "leak", "leck", "wasser"), BinarySensorDeviceClass.MOISTURE),
    (("gas",), BinarySensorDeviceClass.GAS),
    (("lock", "schloss", "verriegel"), BinarySensorDeviceClass.LOCK),
    (("vibration", "erschütter", "erschuetter"), BinarySensorDeviceClass.VIBRATION),
)
