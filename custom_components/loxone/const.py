...
# Automatic UDP setup also for Gateway/Client archives (one program per
# Miniserver). Off by default, so an update alone changes nothing. The option
# key keeps its historical name so saved options stay valid.
